...
class FlowUncPrediction(nn.Module):
    def __init__(self, seq_len):
        super(FlowUncPrediction, self).__init__()
        self.conv1 = nn.Conv2d(32, 32, kernel_size=3, stride=1, padding=1)
        self.conv2 = nn.Conv2d(32, 2 * seq_len, kernel_size=1, stride=1, padding=0)
...
#         self.conv4_1 = nn.Conv2d(256 + 128, 128, kernel_size=3, stride=1, padding=1)
#         self.conv4_2 = nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=1)

#         self.conv5_1 = nn.Conv2d(128 + 64, 64, kernel_size=3, stride=1, padding=1)
#         self.conv5_2 = nn.Conv2d(64, 64, kernel_size=3, stride=1, padding=1)

#         self.conv6_1 = nn.Conv2d(64 + 32, 32, kernel_size=3, stride=1, padding=1)
...
#         self.conv_suf_1 = nn.Conv2d(32, height_feat_size, kernel_size=3, stride=1, padding=1)
#         self.conv_suf_2 = nn.Conv2d(height_feat_size, height_feat_size, kernel_size=3, stride=1, padding=1)
#         self.bn_suf_1 = nn.BatchNorm2d(height_feat_size)
#         self.bn_suf_2 = nn.BatchNorm2d(height_feat_size)
...
#         # TODO: comment this block when seq<=3
#         x_2 = x_2.view(batch, -1, x_2.size(1), x_2.size(2), x_2.size(3)).contiguous()  # (batch, seq, c, h, w)
#         x_2 = self.conv3d_2(x_2)
#         x_2 = x_2.view(-1, x_2.size(2), x_2.size(3), x_2.size(4)).contiguous()  # (batch * seq, c, h, w), seq = 1
#         ##############################
...
#         # -------------------------------- Decoder Path --------------------------------
#         x_4 = F.relu(self.bn4_1(self.conv4_1(torch.cat((F.interpolate(x_3, scale_factor=(2, 2)), x_2), dim=1))))
#         x_4 = F.relu(self.bn4_2(self.conv4_2(x_4)))
...
#         x_5 = F.relu(self.bn5_1(self.conv5_1(torch.cat((F.interpolate(x_4, scale_factor=(2, 2)), x_1), dim=1))))
#         x_5 = F.relu(self.bn5_2(self.conv5_2(x_5)))
...
#         x_6 = F.relu(self.bn6_1(self.conv6_1(torch.cat((F.interpolate(x_5, scale_factor=(2, 2)), x), dim=1))))
#         x = F.relu(self.bn6_2(self.conv6_2(x_6)))

#         # x = F.relu(self.bn_suf_1(self.conv_suf_1(x)))
#         # x = F.relu(self.bn_suf_2(self.conv_suf_2(x)))
