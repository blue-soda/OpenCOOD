...
class DoubleConv(nn.Module):
    ...
    def __init__(self, in_channels, out_channels,stride=1, mid_channels=None):
        ...
        self.double_conv = nn.Sequential(
            nn.Conv2d(in_channels, mid_channels, stride=stride, kernel_size=3, padding=1, bias=False),
            nn.BatchNorm2d(mid_channels),
            nn.PReLU(),
            nn.Conv2d(mid_channels, out_channels, stride=1, kernel_size=3, padding=1, bias=False),
